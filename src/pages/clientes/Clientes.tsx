						...
						<tr className="w-full flex gap-4">
							...
							<td className="py-2 w-1/4 flex gap-5">
								<Link to={`"/items/show/"`} className="text-black">
									<button
										type="button"
										className="bg-blue-500 px-3 py-1 border-0 hover:scale-105 rounded-sm"
									>
										Ver
									</button>
								</Link>
								<Link to={`"/items/update/"`} className="text-black">
									<button
										type="button"
										className="bg-white px-3 py-1 border-0 hover:scale-105 rounded-sm"
									>
										Atualizar
									</button>
								</Link>
								<button
									type="button"
									className="bg-red-500 text-black px-3 py-1 border-0 hover:scale-105 rounded-sm"
								>
									Excluir
								</button>
							</td>
